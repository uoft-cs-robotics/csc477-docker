...
## Requirements
 ...
 2. docker images
 3. if csc477 present - skip to step 8, otherwise continue to step 4
 4. git clone https://mcsgitlab.utm.utoronto.ca/zetkoger/csc477-docker.git
 5. cd csc477-docker/
 6. docker build -t "csc477" .
 7. docker run -P -d --name csc477 -v /path/to/csc477_winter24:/home/ubuntu/csc477_ws/src csc477
...
## Steps
 ...
 4. docker run -P -d --name csc477 -v /path/to/csc477_winter24:/home/ubuntu/csc477_ws/src csc477
